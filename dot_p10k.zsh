# Generated by Powerlevel10k configuration wizard on 2021-05-03 at 17:05 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    root_indicator          # shows # if running as root
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OVERWRITE_STATE=false  # HACK was true, see https://github.com/Aloxaf/fzf-tab/issues/176
  ...
  # Context format when running with privileges: bold user  # was user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%B%n'  # was '%B%n@%m'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%n@%m'
  # Default context format (no privileges, no SSH): user  # wasuser@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n'  # was '%n@%m'
  ...
  typeset -g POWERLEVEL9K_TRANSIENT_PROMPT=off  # was same-dir
  ...
  # really need it.
  typeset -g POWERLEVEL9K_DISABLE_HOT_RELOAD=false  # turn true for testing
